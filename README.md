...
**على ويندوز — ملفّ تنفيذيّ.** حمّل [`tools/masrouf.exe`](tools/masrouf.exe) (٧KB)
وشغّله: يضع أيقونةً على سطح المكتب وفي قائمة ابدأ، ويفتح التطبيق في نافذةٍ مستقلّة.

> هو **مشغّلٌ لا نسخةٌ مُحزَّمة** — عن قصد. لو حُشرت الشيفرة داخله لتجمّدت نسختك
> عند يوم تنزيلها، ولاحتاج كلّ تحديثٍ تنزيلاً جديداً. وهكذا يبقى التحديث تلقائياً.
>
> وويندوز سيعرض تحذير SmartScreen لأنه غير موقَّع رقمياً (التوقيع يُشترى سنوياً).
> اضغط **«مزيد من المعلومات» ← «تشغيل على أي حال»**، أو استعمل التثبيت من المتصفّح
> وتجنّب المسألة كلّها.
...
الملفّ التنفيذي يُبنى بـ`python tools/build_exe.py` — بلا حزم ولا تنزيل،
